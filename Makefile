...
UnitTest: dependencies UserLogin.h UnitTest.cpp
	clang++ --std=c++17 -Wall -g -lpthread -lgtest_main -lgtest -lpthread UnitTest.cpp -o UnitTest

clean:
	rm -f rubricscore ${TEST_XML} resultOutput.json UnitTest
